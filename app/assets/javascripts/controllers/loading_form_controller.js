  ...
  connect() {
    this.element.addEventListener("submit", _event => {
      ...
      if(submitBtn) {
        ...
        submitBtn.innerHTML += '<svg class="text-gray-200 animate-spin dark:text-gray-600 fill-blue-600 inline h-4 w-4 ml-2" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">\
