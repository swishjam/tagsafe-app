module PerformanceAuditManager
  class AveragePerformanceAuditsCreator
    ...
    def avg_perf_audit_attrs(individual_performance_audits)
      {
        audit: @audit.is_a?(Audit) ? @audit : nil,
        ...
        main_thread_blocking_execution_tag_responsible_for: average_for(:main_thread_blocking_execution_tag_responsible_for, individual_performance_audits),
        entire_main_thread_execution_ms: average_for(:entire_main_thread_execution_ms, individual_performance_audits),
        entire_main_thread_blocking_executions_ms: average_for(:entire_main_thread_blocking_executions_ms, individual_performance_audits),
