...
#         return true if @tag.has_no_versions?
#         return false if @fetched_content.nil?
#         return true if Util.env_is_true('DONT_REQUIRE_DETECTABLE_DIFFERENCES_IN_CONTENT_FOR_NEW_RELEASE_DETECTION')
...
#         return false if Util.env_is_true('DONT_CHECK_IF_TAG_HAS_SAME_CONTENT_IN_PREVIOUS_RELEASE_FOR_NEW_RELEASE_DETECTION')
