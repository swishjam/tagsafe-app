module FeatureGateKeepers
  class CanRunManualTestRun < Base
    def can_access_feature?
      return true unless subscription_feature_restriction.max_manual_test_runs_per_month.present?
      num_manual_test_runs = domain.test_runs
                                        ...
                                        .count
      if num_manual_test_runs >= subscription_feature_restriction.max_manual_test_runs_per_month
        @reason = <<~REASON
