      ...
      def request_payload
        {
          ...
          third_party_tag_url_patterns_to_block: [],
          third_party_tags_to_overwrite: [{ request_url_pattern: tag.url_based_on_preferences, overwrite_url: @tag_version.google_cloud_js_file_url }],
