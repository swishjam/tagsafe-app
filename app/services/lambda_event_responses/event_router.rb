module LambdaEventResponses
  class EventRouter
    ...
    def route_event_to_respective_lambda_event_response_and_process!
      if !event_results_processor_klass.has_no_executed_lambda_function? && event_results_processor.record.received_lambda_response?
    ...
    def process_result!
      ...
      event_results_processor.record.received_lambda_response!(response_payload: lambda_event_payload['responsePayload']) unless event_results_processor_klass.has_no_executed_lambda_function?
