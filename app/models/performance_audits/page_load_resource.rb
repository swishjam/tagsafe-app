class PageLoadResource < ApplicationRecord
  ...
  def resource_type_icon_html
    {
      'img' => "<img src='#{name.starts_with?('/') ? performance_audit.audit.tag.container.parsed_container_url + name : name}' style='position: relative; height: 100%; max-width: 100px;'>".html_safe,
