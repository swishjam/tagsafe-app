class HoneycombsController < LoggedInController
  ...
  def chart
    tags = current_domain.tags.is_third_party_tag.still_on_site.includes(:tag_identifying_data, :tag_preferences, most_current_audit: :average_delta_performance_audit)
