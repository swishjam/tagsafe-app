class AddFieldsForEnforcingConfidentTagsafeScores < ActiveRecord::Migration[6.1]
  def up
    ...
    add_column :configurations, :perf_audit_completion_indicator_type, :string
    add_column :configurations, :perf_audit_required_tagsafe_score_range, :float
    rename_column :configurations, :num_perf_audit_iterations, :num_perf_audits_to_run
