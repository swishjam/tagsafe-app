...
ActiveRecord::Schema.define(version: 2022_12_07_202225) do
  ...
  create_table "audits", charset: "utf8mb3", force: :cascade do |t|
    ...
    t.index ["js_script_id"], name: "index_audits_on_js_script_id"
  ...
  create_table "aws_event_bridge_rules", charset: "utf8mb3", force: :cascade do |t|
    t.string "uid"
    t.string "name"
    t.boolean "enabled"
    t.string "type"
  ...
  create_table "bulk_debits", charset: "utf8mb3", force: :cascade do |t|
    t.string "uid"
  ...
  create_table "credit_wallet_notifications", charset: "utf8mb3", force: :cascade do |t|
    t.string "uid"
    t.bigint "credit_wallet_id"
    t.string "type"
  ...
  create_table "credit_wallet_transactions", charset: "utf8mb3", force: :cascade do |t|
    t.string "uid"
    t.bigint "credit_wallet_id"
  ...
  create_table "credit_wallets", charset: "utf8mb3", force: :cascade do |t|
    t.string "uid"
    t.bigint "domain_id"
    t.integer "month"
  ...
  create_table "feature_prices_in_credits", charset: "utf8mb3", force: :cascade do |t|
    t.string "uid"
    t.bigint "domain_id"
  ...
  create_table "js_script_configurations", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "js_script_id"
    t.string "type"
    t.boolean "enabled"
    ...
    t.string "uid"
    t.index ["js_script_id"], name: "index_js_script_configurations_on_js_script_id"
  end

  create_table "js_scripts", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "uid"
    t.bigint "domain_id"
    t.bigint "created_by_domain_user_id"
    t.bigint "tag_identifying_data_id"
    t.boolean "has_staged_changes"
    t.string "name"
    t.string "js_content_fingerprint"
    t.timestamp "tag_last_released_at"
    t.timestamp "last_audit_began_at"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["created_by_domain_user_id"], name: "index_js_scripts_on_created_by_domain_user_id"
    t.index ["domain_id"], name: "index_js_scripts_on_domain_id"
    t.index ["tag_identifying_data_id"], name: "index_js_scripts_on_tag_identifying_data_id"
    t.index ["uid"], name: "index_js_scripts_on_uid"
  end

  create_table "long_tasks", charset: "utf8mb3", force: :cascade do |t|
    t.bigint "performance_audit_id"
    t.bigint "tag_id"
  ...
  create_table "performance_audit_speed_index_frames", charset: "utf8mb3", force: :cascade do |t|
    t.string "uid"
    t.bigint "performance_audit_id"
    t.string "s3_url"
  ...
  create_table "release_check_batches", charset: "utf8mb3", force: :cascade do |t|
    t.string "uid"
    t.string "batch_uid"
  ...
  create_table "subscription_features_configurations", charset: "utf8mb3", force: :cascade do |t|
    t.string "uid"
  ...
  create_table "subscription_usage_record_updates", charset: "utf8mb3", force: :cascade do |t|
    t.bigint "subscription_plan_id"
    t.bigint "domain_id"
  ...
  create_table "uptime_check_batches", charset: "utf8mb3", force: :cascade do |t|
    t.string "uid"
    t.string "batch_uid"
  ...
  create_table "uptime_checks", charset: "utf8mb3", force: :cascade do |t|
    t.string "uid"
  ...
  create_table "uptime_regions", charset: "utf8mb3", force: :cascade do |t|
    t.string "uid"
    t.string "aws_name"
    t.string "location"
  ...
  create_table "uptime_regions_to_check", charset: "utf8mb3", force: :cascade do |t|
    t.bigint "tag_id"
    t.string "uid"
    t.bigint "uptime_region_id"
