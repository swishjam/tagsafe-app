...
module.exports = class Tracer {
  ...
  startTracing = async () => {
    console.log(`Beginning trace! File: ${this.localFilePath}`);
    await this.page.tracing.start({ path: this.localFilePath, screenshots: this.screenshotsEnabled, categories: DEFAULT_CATEGORIES });
  }
